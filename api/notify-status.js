...
const STATUS_MESSAGES = {
  ...
  // Booking-специфичные статусы. Используются админкой /admin/bookings
  // при смене статуса брони. По смыслу зеркалят visa pipeline, но текст
  // про бронь, не про визу.
  booking_in_progress: {
    emoji: '⚙️',
    title: 'Бронь в работе',
    body: 'Мы взяли вашу бронь в работу. Скоро пришлём подтверждение.',
  },
  booking_confirmed: {
    emoji: '🎉',
    title: 'Бронь готова!',

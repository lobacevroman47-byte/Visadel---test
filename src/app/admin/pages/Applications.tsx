...
const ANKETA_BY_COUNTRY: Record<string, Array<{ key: string; label: string }>> = {
  'Индия': [
    ...
    { key: 'twoYearsResidence', label: 'Прожили не менее 2 лет в стране оформления визы' },
    { key: 'registrationAddress', label: 'Адрес регистрации' },
    { key: 'residenceAddress', label: 'Адрес проживания' },
    { key: 'fatherInfo', label: 'Данные отца' },
    { key: 'motherInfo', label: 'Данные матери' },
    { key: 'maritalStatus', label: 'Семейное положение' },
    { key: 'spouseInfo', label: 'Информация о супруге' },
    { key: 'employment', label: 'Место работы' },
    { key: 'militaryService', label: 'Служили в армии/полиции' },
    { key: 'visaRejection', label: 'Отказы в индийской визе ранее' },
    { key: 'placesToVisit', label: 'Города/места планируемого посещения в Индии' },
    { key: 'countriesVisited', label: 'Страны, посещённые за последние 10 лет' },
    { key: 'previousIndiaVisit', label: 'Посещали ранее Индию' },
    { key: 'neighborCountries', label: 'Посещения Бангладеш / Бутан / Мальдив / Непал / Пакистан / Шри-Ланка / Афганистан за 3 года' },
    { key: 'hotelInfo', label: 'Отель: название / адрес / телефон' },
  ...
  'Вьетнам': [
    ...
    { key: 'oldPassport', label: 'Использовали другие паспорта для въезда во Вьетнам' },
    { key: 'stayDates', label: 'Предполагаемые даты пребывания' },
    { key: 'registrationAddress', label: 'Адрес регистрации/прописки' },
    { key: 'currentAddress', label: 'Адрес текущего проживания' },
    { key: 'emergencyContact', label: 'Контактное лицо на экстренный случай' },
    { key: 'employment', label: 'Место работы / учёбы' },
    { key: 'purpose', label: 'Цель визита' },
    { key: 'contacts', label: 'Контакт с агентствами/организациями во Вьетнаме' },
    { key: 'arrivalAirport', label: 'Аэропорт прилёта во Вьетнам' },
    { key: 'departureAirport', label: 'Аэропорт вылета из Вьетнама' },
    { key: 'vietnamAddress', label: 'Адрес проживания во Вьетнаме' },
    { key: 'previousVisits', label: 'Предыдущие визиты во Вьетнам за год' },
    { key: 'childInfo', label: 'Данные ребёнка (если вписан в паспорт)' },
    { key: 'insurance', label: 'Информация по страховке' },
    { key: 'expectedExpenses', label: 'Ожидаемая сумма расходов во Вьетнаме ($)' },
  ],
  'Шри-Ланка': [
    { key: 'citizenship', label: 'Гражданство' },
    { key: 'birthCountry', label: 'Страна рождения' },
    ...
    { key: 'residentVisa', label: 'Действующая резидентская виза на Шри-Ланку' },
    { key: 'onSriLanka', label: 'Уже на Шри-Ланке по действующему разрешению' },
    { key: 'multipleVisa', label: 'Многократная виза на Шри-Ланку' },
  ],
  'Южная Корея': [
    ...
    { key: 'contactsInKorea', label: 'Знакомые в Корее' },
    { key: 'travelCompanions', label: 'Сопровождающие в поездке' },
    { key: 'employment', label: 'Работаете' },
  ...
  'Пакистан': [
    ...
    { key: 'maritalStatus', label: 'Семейное положение' },
    { key: 'parentsInfo', label: 'Данные отца и матери' },
    { key: 'employment', label: 'Место работы' },
  ...
  'Кения': [
    ...
    { key: 'travelDates', label: 'Дата прилёта и вылета' },

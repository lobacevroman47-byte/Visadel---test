...
import { ChevronLeft, User, Plane, Mail, Phone, Send, Upload, Check, Loader2, FileText, X, MapPin, Calendar } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-[#F5F7FA] flex flex-col items-center justify-center px-5">
        ...
        <p className="text-center text-sm text-[#0F2A36]/65 mt-3 max-w-xs">
          Мы получили вашу заявку на бронь авиабилета и свяжемся в Telegram в течение нескольких часов.
        </p>
        <button
          onClick={onComplete}
    ...
    <div className="min-h-screen bg-[#F5F7FA] pb-24">
      ...
      <div className="vd-grad-soft px-5 pt-7 pb-6 max-w-2xl mx-auto">
        ...
        <p className="text-center text-[12px] text-[#0F2A36]/60 mt-3">
          Заполни 3 минуты — пришлём подтверждение для посольства
        </p>
      </div>

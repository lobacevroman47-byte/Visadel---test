    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-2">
          ...
          <div>
            ...
            <ul className="text-sm text-yellow-800 space-y-1 list-disc list-inside">
              ...
              <li>Фото лица - на светлом фоне, анфас, ~80% лица</li>
              <li>Без очков на фото лица</li>
              <li>Паспорт: вся информация должна быть читаема</li>
              <li>Срок действия паспорта ≥6 месяцев</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div>
        <label className="block text-sm mb-3 text-gray-700">
          ...
          Фото лица <span className="text-red-500">*</span>
        </label>
        ...
        {!facePreview ? (
          <label className="block">
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition-colors">
              ...
              <p className="text-sm text-gray-500">JPG, PNG, PDF (макс. 5MB)</p>
            </div>
          </label>
        ) : (
      ...
      <div>
        <label className="block text-sm mb-3 text-gray-700">
          ...
          Фото загранпаспорта (разворот с фото) <span className="text-red-500">*</span>
        </label>

      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• +500₽ за друга с оплаченной визой</li>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="text-gray-900 mb-1">Партнёры</h4>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• До 20% с каждого заказа (визы, отели, билеты, страховки)</li>
                <li>• 100% оплата бонусами без ограничений</li>
                <li>• Подробная статистика по каждому реферальному заказу</li>
                <li>• Проценты по услугам — в партнёрском кабинете</li>
              </ul>
            </div>
          </div>
        </div>
